...
if (isset($_GET)) {
	if ($_GET['isAdd'] == 'true') {
		...
		$sql = "INSERT INTO `payment`(`pay_id`, `slip_date_time`, `image_slip`, `order_id`, `user_id`, `user_name`, `total`, `emp_id`) VALUES (Null,now(),'$image_slip','$order_id','$user_id','$user_name','$total','$emp_id')";
